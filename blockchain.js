...
async function claimTokens() {
    const runTokenContractAddress = "0x1D84f431963A9B569F471cF8d812c2dAB467352a";
    ...
    let amountToClaim = window.totalBPAYScore * convertToWei
    await runTokenContract.connect(signer).mintTokens(signer.getAddress(), amountToClaim.toString())
}

async function claimNft() {
    const nftContractAddress = "0x95447b55b57a75CEB070789b4b8519EfE4F8d484";
